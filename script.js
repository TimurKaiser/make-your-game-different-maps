...
window.onload = function() {
    ...
    map1 = document.getElementById("map1").addEventListener("click", ()=>{
        location.reload()
    });
    map2 = document.getElementById("map2").addEventListener("click", changeMap2);
    map3 = document.getElementById("map3").addEventListener("click", changeMap3);
...
function changeMap2() {
    ...
    board.style.width = (boardWidth * 2) + "px";
    board.style.height = (boardHeight * 2) + "px";
    ...
    playerState.x = boardWidth - playerWidth ;
    playerState.y = boardHeight - playerHeight - 100;
    ballState.x = boardWidth / 2 - ballWidth / 2;
    ballState.y = boardHeight / 2 - ballHeight / 2;

    initialBallVelocityX = ballVelocityX;
    initialBallVelocityY = ballVelocityY;
...
function changeMap3() {
    ...
    board.style.width = (boardWidth / 1.5) + "px";
    board.style.height = (boardHeight / 1.5) + "px";
